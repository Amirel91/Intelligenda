    ...
    return (
      <div className="min-h-screen flex items-center justify-center dark:bg-stone-800/50 bg-stone-50 px-6">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-semibold dark:text-stone-100 text-stone-900 mb-2">Password aggiornata!</h1>
    ...
    <div className="min-h-screen flex items-center justify-center dark:bg-stone-800/50 bg-stone-50 px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold dark:text-stone-100 text-stone-900">Nuova Password</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium dark:text-stone-300 text-stone-700 mb-1.5">Conferma Password</label>
            <div className="relative">
              <input
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center dark:bg-stone-800/50 bg-stone-50 px-6">
        <div className="animate-spin w-8 h-8 border-3 dark:border-stone-600 border-stone-300 border-t-stone-900 rounded-full" />
      </div>
    }>
      <ResetPasswordForm />
    </Suspense>
