  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="bg-white rounded-2xl border border-stone-200 p-6 shadow-sm">
        ...
        {step === 'success' && (
          <div className="text-center py-6">
            ...
            <h3 className="text-lg font-semibold text-stone-900 mb-1">Account creato!</h3>
      ...
      <p className="text-center text-sm text-stone-400 mt-6">
        Hai gia un account?{' '}
        <Link href={`/login?callback=${encodeURIComponent(callbackUrl)}`} className="text-stone-900 font-medium hover:underline">
          Accedi qui
        </Link>
      </p>
    </div>
